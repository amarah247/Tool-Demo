...
const MENUITEMS = [
    {state: 'imports', name:'Imports Page', type:'link',icon:'view_list'},
    {state: 'kpi', name:'Audits Page', type:'link',icon:'blur_circular'},
    {state: 'kpi', name:'KPI Page', type:'link',icon:'blur_circular'},
